...
void I::rotate(char board[20][10]) {
...
char I::getChar() { return mChar; }

float I::getCenterX() { return centerX; }
float I::getCenterY() { return centerY; }

int I::getStartingRow() { return startRow; }

vector<vector<char>> I::getSprite() {
...
bool I::movePos(char board[20][10], int moveX, int moveY) {
    // COLLISION CHECKING
    for(int i = -2; i <= 2; i++) {                     
        for(int j = -2; j <= 2; j++) {                  
